...
/**
 * A classe PHPMailer é utilizada e disponibilizada juntamente com o pacote PHPMailer.
 * 
 * Sua utilização envolve a configuração necessária para o envio de e-mails utilizando o PHP.
 * 
 * No sistema ARTE, da Fábrica de Software, ela foi utilizada no módulo recuperarsenha. 
 * 
 * Endereço para download: http://sourceforge.net/projects/phpmailer/ 
 */
/* ~ class.phpmailer.php
  .---------------------------------------------------------------------------.
